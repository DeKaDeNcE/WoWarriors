...
--
-- Host: localhost    Database: hotfixes_8
-- ------------------------------------------------------
...
CREATE TABLE `barber_shop_style_locale` (
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `locale` varchar(4) NOT NULL,
  `DisplayName_lang` text DEFAULT NULL,
  `Description_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `battle_pet_breed_state` (
  ...
  `BattlePetBreedID` tinyint(3) unsigned NOT NULL DEFAULT 0,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `battle_pet_species_locale` (
  ...
  `locale` varchar(4) NOT NULL,
  `Description_lang` text DEFAULT NULL,
  `SourceText_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `battlemaster_list_locale` (
  ...
  `locale` varchar(4) NOT NULL,
  `Name_lang` text DEFAULT NULL,
  `GameType_lang` text DEFAULT NULL,
  `ShortDescription_lang` text DEFAULT NULL,
  `LongDescription_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chat_channels_locale` (
  ...
  `locale` varchar(4) NOT NULL,
  `Name_lang` text DEFAULT NULL,
  `Shortcut_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chr_classes_locale` (
  ...
  `locale` varchar(4) NOT NULL,
  `Name_lang` text DEFAULT NULL,
  `NameMale_lang` text DEFAULT NULL,
  `NameFemale_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chr_races_locale` (
  ...
  `Name_lang` text DEFAULT NULL,
  `NameFemale_lang` text DEFAULT NULL,
  `NameLowercase_lang` text DEFAULT NULL,
  `NameFemaleLowercase_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chr_specialization_locale` (
  ...
  `locale` varchar(4) NOT NULL,
  `Name_lang` text DEFAULT NULL,
  `FemaleName_lang` text DEFAULT NULL,
  `Description_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `emotes` (
  ...
  `EmoteSlashCommand` text DEFAULT NULL,
...
CREATE TABLE `garr_building_locale` (
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `locale` varchar(4) NOT NULL,
  `HordeName_lang` text DEFAULT NULL,
  `AllianceName_lang` text DEFAULT NULL,
  `Description_lang` text DEFAULT NULL,
  `Tooltip_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `garr_class_spec` (
  `ClassSpec` text DEFAULT NULL,
  `ClassSpecMale` text DEFAULT NULL,
  `ClassSpecFemale` text DEFAULT NULL,
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `UiTextureAtlasMemberID` smallint(5) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE `garr_class_spec_locale` (
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `locale` varchar(4) NOT NULL,
  `ClassSpec_lang` text DEFAULT NULL,
  `ClassSpecMale_lang` text DEFAULT NULL,
  `ClassSpecFemale_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `garr_follower` (
  `HordeSourceText` text DEFAULT NULL,
  `AllianceSourceText` text DEFAULT NULL,
...
CREATE TABLE `garr_follower_locale` (
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `locale` varchar(4) NOT NULL,
  `HordeSourceText_lang` text DEFAULT NULL,
  `AllianceSourceText_lang` text DEFAULT NULL,
  `TitleName_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `glyph_bindable_spell` (
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `SpellID` int(11) NOT NULL DEFAULT 0,
  `GlyphPropertiesID` smallint(6) NOT NULL DEFAULT 0,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_bonus_tree_node` (
  ...
  `ParentItemBonusTreeID` smallint(5) unsigned NOT NULL DEFAULT 0,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_class_locale` (
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `locale` varchar(4) NOT NULL,
  `ClassName_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_level_selector_quality` (
  ...
  `Quality` tinyint(4) NOT NULL DEFAULT 0,
  `ParentILSQualitySetID` smallint(6) NOT NULL DEFAULT 0,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_search_name_locale` (
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `locale` varchar(4) NOT NULL,
  `Display_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_sparse_locale` (
  ...
  `locale` varchar(4) NOT NULL,
  `Description_lang` text DEFAULT NULL,
  `Display3_lang` text DEFAULT NULL,
  `Display2_lang` text DEFAULT NULL,
  `Display1_lang` text DEFAULT NULL,
  `Display_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `item_upgrade` (
  ...
  `CurrencyAmount` int(10) unsigned NOT NULL DEFAULT 0,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `map_difficulty_locale` (
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `locale` varchar(4) NOT NULL,
  `Message_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `map_locale` (
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `locale` varchar(4) NOT NULL,
  `MapName_lang` text DEFAULT NULL,
  `MapDescription0_lang` text DEFAULT NULL,
  `MapDescription1_lang` text DEFAULT NULL,
  `PvpShortDescription_lang` text DEFAULT NULL,
  `PvpLongDescription_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player_condition_locale` (
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `locale` varchar(4) NOT NULL,
  `FailureDescription_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `power_display` (
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `GlobalStringBaseTag` text DEFAULT NULL,
...
CREATE TABLE `quest_sort_locale` (
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `locale` varchar(4) NOT NULL,
  `SortName_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `skill_line` (
  `DisplayName` text DEFAULT NULL,
  `AlternateVerb` text DEFAULT NULL,
  `Description` text DEFAULT NULL,
  `HordeDisplayName` text DEFAULT NULL,
  `OverrideSourceInfoDisplayName` text DEFAULT NULL,
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE `skill_line_locale` (
  ...
  `locale` varchar(4) NOT NULL,
  `DisplayName_lang` text DEFAULT NULL,
  `AlternateVerb_lang` text DEFAULT NULL,
  `Description_lang` text DEFAULT NULL,
  `HordeDisplayName_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `spell_range` (
  `ID` int(10) unsigned NOT NULL DEFAULT 0,
  `DisplayName` text DEFAULT NULL,
  `DisplayNameShort` text DEFAULT NULL,
  `Flags` tinyint(3) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE `spell_range_locale` (
  ...
  `locale` varchar(4) NOT NULL,
  `DisplayName_lang` text DEFAULT NULL,
  `DisplayNameShort_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `unit_power_bar_locale` (
  ...
  `locale` varchar(4) NOT NULL,
  `Name_lang` text DEFAULT NULL,
  `Cost_lang` text DEFAULT NULL,
  `OutOfError_lang` text DEFAULT NULL,
  `ToolTip_lang` text DEFAULT NULL,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- Dump completed on 2019-07-15 16:01:18
